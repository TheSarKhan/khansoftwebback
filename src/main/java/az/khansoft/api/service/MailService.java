package az.khansoft.api.service;
...
public class MailService {
    ...
    public MailService(
            ...
            @Value("${app.mail.from-name:KhanSoft}") String fromName,
    ...
    public void sendContactNotification(ContactMessage msg) {
        ...
        try {
            ...
            helper.setSubject("[KhanSoft] Yeni mesaj: " + safe(msg.getSubject(), "(mövzu yoxdur)"));
    ...
    private String buildBody(ContactMessage msg) {
        ...
        sb.append("KhanSoft.az saytından yeni mesaj.\n\n");
